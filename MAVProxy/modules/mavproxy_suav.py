...
class suav(mp_module.MPModule):
    ...
    def mavlink_packet(self, m):
        ...
        if m.get_type() == 'GLOBAL_POSITION_INT':
            ...
            print(m.value)
            sg.PopupNoButtons('Test drop!','Altitude: ' + m.value + 'ft', non_blocking=True, no_titlebar=True, font=('Arial', 25), keep_on_top=True, location=[4+255*(self.popcount//7),700-(110*self.popcount)%770])
            self.popcount += 1
